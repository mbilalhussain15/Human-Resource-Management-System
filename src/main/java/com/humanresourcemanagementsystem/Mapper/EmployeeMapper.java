...
public interface EmployeeMapper {
    ...
    @Mapping(source = "employee.department", target = "departmentId")
    ...
    @Mapping(source = "person.createdAt", target = "createdAt")
    @Mapping(source = "person.updatedAt", target = "updatedAt")
    // Correct mapping from the department object to the departmentId field
    @Mapping(source = "employee.department", target = "departmentId")
//    @Mapping(source = "employee.employmentType", target = "employmentType")
//    @Mapping(source = "employee.manageWhom", target = "manageWhom")
